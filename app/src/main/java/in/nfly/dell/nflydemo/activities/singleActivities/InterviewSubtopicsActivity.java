...
public class InterviewSubtopicsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interview_subtopics);
        ...
        layoutManager=new LinearLayoutManager(InterviewSubtopicsActivity.this,LinearLayoutManager.VERTICAL,false);
    ...
    private void setValues() {
        StringRequest stringRequest=new StringRequest(Request.Method.POST, urlInterviewSubTopics, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    adapter=new InterviewSubTopicsAdapter(InterviewSubtopicsActivity.this,titleDataSet,idDataSet);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(InterviewSubtopicsActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
        ...
        MySingleton.getmInstance(InterviewSubtopicsActivity.this).addToRequestQueue(stringRequest);
    }
}
