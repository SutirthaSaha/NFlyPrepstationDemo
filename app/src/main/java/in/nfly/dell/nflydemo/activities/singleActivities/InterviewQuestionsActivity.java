...
public class InterviewQuestionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        easyLayoutManager=new LinearLayoutManager(InterviewQuestionsActivity.this,LinearLayoutManager.VERTICAL,false);
        ...
        mediumLayoutManager=new LinearLayoutManager(InterviewQuestionsActivity.this,LinearLayoutManager.VERTICAL,false);
        ...
        difficultLayoutManager=new LinearLayoutManager(InterviewQuestionsActivity.this,LinearLayoutManager.VERTICAL,false);
    ...
    private void setValues() {
        StringRequest stringRequest=new StringRequest(Request.Method.POST, urlInterviewQuestions, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    easyAdapter=new InterviewQuestionsAdapter(InterviewQuestionsActivity.this,easyQuestionsDataSet,easyAnswersDataSet);
                    easyInterviewQuestionsRecyclerView.setAdapter(easyAdapter);

                    mediumAdapter=new InterviewQuestionsAdapter(InterviewQuestionsActivity.this,mediumQuestionsDataSet,mediumAnswersDataSet);
                    mediumInterviewQuestionsRecyclerView.setAdapter(mediumAdapter);

                    difficultAdapter=new InterviewQuestionsAdapter(InterviewQuestionsActivity.this,difficultQuestionsDataSet,difficultAnswersDataSet);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(InterviewQuestionsActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
        ...
        MySingleton.getmInstance(InterviewQuestionsActivity.this).addToRequestQueue(stringRequest);
    }
}
