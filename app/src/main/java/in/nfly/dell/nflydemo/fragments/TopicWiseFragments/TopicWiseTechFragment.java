 ...
 */
public class TopicWiseTechFragment extends Fragment {

    private RecyclerView topicWiseTechRecyclerView;
    private RecyclerView.Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private ImageView topicWiseTechImage;
    ...
    private String urlTech="http://nfly.in/gapi/load_rows_one";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_topic_wise_tech, container, false);
        topicWiseTechRecyclerView=v.findViewById(R.id.topicWiseTechRecyclerView);
        layoutManager=new GridLayoutManager(getContext(),2);
        topicWiseTechRecyclerView.setLayoutManager(layoutManager);
        setValues();
        return v;
    }
    private void setValues() {
        StringRequest stringRequest=new StringRequest(Request.Method.POST, urlTech, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    topicWiseTechRecyclerView.setAdapter(adapter);
