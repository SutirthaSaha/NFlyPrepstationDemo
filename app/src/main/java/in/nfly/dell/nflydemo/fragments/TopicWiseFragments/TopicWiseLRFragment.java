 ...
 */
public class TopicWiseLRFragment extends Fragment {

    private RecyclerView topicWiseLRRecyclerView;
    private RecyclerView.Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private ImageView topicWiseLRImage;
    private String urlLR="http://nfly.in/gapi/load_rows_one";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_topic_wise_lr, container, false);
        topicWiseLRRecyclerView=v.findViewById(R.id.topicWiseLRRecyclerView);
        layoutManager=new GridLayoutManager(getContext(),2);
        topicWiseLRRecyclerView.setLayoutManager(layoutManager);
        setValues();
        return v;
    }
    private void setValues() {
        StringRequest stringRequest=new StringRequest(Request.Method.POST, urlLR, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    topicWiseLRRecyclerView.setAdapter(adapter);
